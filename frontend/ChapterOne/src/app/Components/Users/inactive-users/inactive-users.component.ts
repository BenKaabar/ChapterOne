...
export class InactiveUsersComponent implements OnInit {
  ...
  //  ********************************************************************** Reactive user **********************************************************************
  openReactiveModal(user: User): void {
    this.selectedUser = user;
    const consultModalElement = document.getElementById('reactiveUserModal');
    if (consultModalElement) {
      const consultModal = new bootstrap.Modal(consultModalElement);
      consultModal.show();
    }
  }
  closeReactiveModal(): void {
    const consultModalElement = document.getElementById('reactiveUserModal');
    if (consultModalElement) {
      const consultModal = bootstrap.Modal.getInstance(consultModalElement);
      consultModal?.hide();
  ...
  ReactiveUser(idUser: string) {
    this.closeReactiveModal();
  }
