...
@Component({
  selector: 'app-late-borrowed',
  templateUrl: './late-borrowed.component.html',
  styleUrls: ['./late-borrowed.component.css']
})
export class LateBorrowedComponent implements OnInit {
  theme: string = 'light';
  page: number = 1;
